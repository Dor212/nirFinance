...
const credentials = ["CFP מוסמך", "יועץ משכנתאות ומימון", "יועץ לכלכלת המשפחה"];
                ...
                <div className="text-center lg:text-right" dir="rtl">
                    ...
                    <div className="mt-4 flex flex-wrap items-center justify-center gap-2 lg:justify-start">
                        {credentials.map((c) => (
                            <span
                                key={c}
                                className="rounded-full border border-[var(--lime)]/30 bg-[var(--lime)]/10 px-4 py-1.5 text-xs font-bold text-[var(--lime)]"
                            >
                                {c}
                            </span>
                        ))}

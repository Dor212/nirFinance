                                ...
                                {!isPlaying && (
                                    ...
                                    >
                                        ...
                                        <span className="relative flex items-center justify-center">
                                            ...
                                            {/* Play button */}
                                            <span className="relative flex h-20 w-20 items-center justify-center rounded-full bg-white text-[#1d4339] shadow-[0_12px_40px_rgba(0,0,0,0.4)] transition hover:scale-105">
